...
/*
 * Dark is this site's default theme, not "follow the operating system".
 * A visitor who has never expressed a preference gets dark; `system` remains
 * available as an explicit choice in the appearance switcher.
 */
